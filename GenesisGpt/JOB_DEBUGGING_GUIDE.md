...
GenesisGpt: I'll retrieve debug information for the job etl-job in namespace production...
```
...
GenesisGpt: I'll fetch the trace information for the job...
```
...
GenesisGpt: Let me check the errors for that job...
```
